    ...
    <section className="px-4 py-8 sm:px-6 sm:py-12 md:px-8 lg:px-16 xl:px-28 bg-white text-center">
      ...
      <div className="flex justify-center items-center w-full">
        <div className="relative">
          ...
          <div className="absolute top-1/2 -translate-y-1/2 left-[35%] md:left-[45%] lg:left-[45%] xl:left-[50%] w-60 sm:w-64 md:w-96 lg:w-[22rem] xl:w-[26rem]">
            <div className="bg-black text-white rounded-xl sm:rounded-2xl px-3 py-4 sm:px-5 sm:py-7 md:px-7 md:py-9 lg:px-9 lg:py-11 xl:px-10 xl:py-12 text-left shadow-2xl">
