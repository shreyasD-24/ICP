import profile from "../assets/ProfilPic.jpg";
        ...
        <div className="space-y-1 sm:space-y-2 md:space-y-3 lg:space-y-4 xl:space-y-4 2xl:space-y-6">
          ...
          <div className="flex justify-center mt-2 sm:mt-3 md:mt-4 lg:mt-5 xl:mt-3 2xl:mt-6 3xl:mt-8">
            <img
              src={image}
              alt="Vision Image"
              className="w-full sm:w-full md:w-11/12 lg:w-5/6 xl:w-4/5 2xl:w-19/20 h-auto rounded-lg sm:rounded-xl md:rounded-2xl"
            />
          </div>
        </div>
      </div>
